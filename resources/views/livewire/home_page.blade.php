            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        {{ __('home.hero.content.title') }}
                        <span class="text-blue-600">{{ config('app.name') }}</span>
                    </h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">{{ __('home.hero.content.subtitle') }}</p>
                    ...
                    <div class="mt-7 grid gap-3 w-full sm:inline-flex">
                        <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/register">
                            {{ __('home.hero.buttons.get_started') }}
                        ...
                        <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/contact">
                            {{ __('home.hero.buttons.contact_sales') }}
                        </a>
                    </div>
                    <!-- End Buttons -->
                    ...
                    <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                        ...
                        <div class="py-5">
                            ...
                            <p class="mt-3 text-sm text-gray-800 dark:text-gray-200">
                                <span class="font-bold">
                                    {{ __('home.hero.reviews.first.rating') }}</span> /5 -
                                {{ __('home.hero.reviews.first.summary') }}
                            </p>
                        ...
                        <div class="py-5">
                            ...
                            <p class="mt-3 text-sm text-gray-800 dark:text-gray-200">
                                <span class="font-bold">
                                    {{ __('home.hero.reviews.second.rating') }}</span> /5 -
                                {{ __('home.hero.reviews.second.summary') }}
                            </p>
        ...
        <div class="max-w-2xl mx-auto">
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold dark:text-gray-200"> {!! __('home.brands_section.title_html') !!}</h1>
                ...
                <p class="mb-12 text-base text-center text-gray-500">
                    {{ __('home.brands_section.subtitle') }}
                </p>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 ">
                ...
                @foreach ($brands as $brand)
                    ...
                    <div class="bg-white rounded-lg shadow-md dark:bg-gray-800" wire:key="{{ $brand->id }}">
                        <a wire:navigate href="{{route('products')}}?selected_brands[0]={{$brand->id}}" class="">
            ...
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold dark:text-gray-200">
                        {!! __('home.categories_section.title_html') !!}
                    </h1>
                    <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                        <div class="flex-1 h-2 bg-blue-200">
                        </div>
                ...
                <p class="mb-12 text-base text-center text-gray-500">
                    {{ __('home.categories_section.subtitle') }}
                </p>
            </div>
        </div>
            ...
            <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
                ...
                @foreach ($categories as $category)
                    ...
                    <a wire:navigate
                        ...
                        href="{{route('products')}}?selected_categories[0]={{$category->id}}">
        ...
        <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
            <div class="max-w-2xl mx-auto">
                <div class="text-center ">
                    <div class="relative flex flex-col items-center">
                        <h1 class="text-5xl font-bold dark:text-gray-200">
                            {!! __('home.custom_reviews_section.title_html') !!}
                        </h1>
                        <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                            <div class="flex-1 h-2 bg-blue-200">
                            </div>
                    ...
                    <p class="mb-12 text-base text-center text-gray-500">
                        {{ __('home.custom_reviews_section.subtitle') }}
                    </p>
                </div>
            </div>
                ...
                <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
                    <div
                        ...
                        <p class="px-6 text-base font-medium text-gray-600 dark:text-gray-400">
                            {{ __('home.custom_reviews_section.joined_text') }} 12, SEP , 2022
                        </p>
                    </div>
                    ...
                    <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
                        <div class="flex px-6 mb-2 md:mb-0">
                            ...
                            <h2 class="text-sm text-gray-500 dark:text-gray-400">
                                {{ __('home.custom_reviews_section.rating') }}<span
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="flex text-sm text-gray-700 dark:text-gray-400">
                                    <a href="#" class="inline-flex hover:underline">
                                        ...
                                        </svg>{{ __('home.custom_reviews_section.reply') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
