            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="flex gap-4 py-3 md:py-6 ">
                            @foreach (config('app.supported_locales') as $locale)
                                <button wire:click="switchLocale('{{$locale}}')">
                                    <x-dynamic-component :component="'flag-country-' .  ($locale === 'en' ? 'us' : $locale)"
                                        class="size-6 cursor-pointer focus:outline-none" />
                                </button>
                            @endforeach
                        </div>
                        ...
                        @auth
                            <div class="hs-dropdown py-3 md:py-6">
                                <button type="button"
                                    class="flex items-center w-full text-gray-500 hover:text-gray-400 font-medium dark:text-gray-400 dark:hover:text-gray-500 cursor-pointer">
                                    {{ $login }}
                                ...
                                <div
                                    ...
                                    <a wire:navigate
                                        ...
                                        href="{{ route('my_orders.list') }}">
                                        {{__('navbar.auth.my_orders')}}
                                    </a>

                                    <a wire:navigate
                                        class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                        href="{{ route('my_account') }}">
                                        {{__('navbar.auth.my_account')}}
                                    </a>
                                    <a wire:navigate
                                        class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                        href="{{ route('logout') }}">
