            ...
            <div>
                        ...
                        <div class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start">
                            <div class="flex flex-col items-start justify-start space-y-2">
                                ...
                                <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">
                                    ...
                                    {{ $latest_order->address->zip_code }}
                                </p>
                                <p class="text-sm leading-4 cursor-pointer dark:text-gray-400">
                                    {{ __('success.address.phone') }} {{ $latest_order->address->phone }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200 dark:border-gray-700">
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        <p class="mb-2 text-sm leading-5 text-gray-600 dark:text-gray-400 ">
                            {{ __('success.order_info.order_number') }}
                        </p>
                    ...
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        <p class="mb-2 text-sm leading-5 text-gray-600 dark:text-gray-400 ">
                            {{ __('success.order_info.date') }}
                        </p>
                        <p class="text-base font-semibold leading-4 text-gray-800 dark:text-gray-400">
                            {{ $latest_order->created_at->format('d-m-Y') }}
                        </p>
                    </div>
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        <p class="mb-2 text-sm font-medium leading-5 text-gray-800 dark:text-gray-400 ">
                            {{ __('success.order_info.total') }}
                        </p>
                        <p class="text-base font-semibold leading-4 text-blue-600 dark:text-gray-400">
                            {{ Number::format($latest_order->grand_total, 2)  }} MDL
                        </p>
                    </div>
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        <p class="mb-2 text-sm leading-5 text-gray-600 dark:text-gray-400 ">
                            {{ __('success.order_info.payment_method') }}
                        </p>
                        <p class="text-base font-semibold leading-4 text-gray-800 dark:text-gray-400 ">
                            {{ $latest_order->payment_method === 'cod' ? __('success.order_info.payment_methods.cod') : __('success.order_info.payment_methods.card') }}
                        </p>
                    </div>
                </div>
                    ...
                    <div
                        ...
                        <div class="flex flex-col w-full space-y-6 ">
                            <h2 class="mb-2 text-xl font-semibold text-gray-700 dark:text-gray-400">
                                {{ __('success.order_details.title') }}
                            </h2>
                            <div
                                ...
                                <div class="flex justify-between w-full">
                                    <p class="text-base leading-4 text-gray-800 dark:text-gray-400">
                                        {{ __('success.order_details.subtotal') }}
                                    </p>
                                ...
                                <div class="flex items-center justify-between w-full">
                                    {{-- <p class="text-base leading-4 text-gray-800 dark:text-gray-400"> --}}
                                    <p class="text-base leading-4 text-red-500 dark:text-gray-400">
                                        {{ __('success.order_details.discount') }}
                                    </p>
                                    {{-- <p class="text-base leading-4 text-gray-600 dark:text-gray-400"> --}}
                                    <p class="text-base leading-4 text-red-500 dark:text-gray-400">
                                ...
                                <div class="flex items-center justify-between w-full">
                                    {{-- <p class="text-base leading-4 text-gray-800 dark:text-gray-400"> --}}
                                    <p class="text-base leading-4 text-red-500 dark:text-gray-400">
                                        {{ __('success.order_details.shipping') }}
                                    </p>
                                    {{-- <p class="text-base leading-4 text-gray-600 dark:text-gray-400"> --}}
                                    <p class="text-base leading-4 text-red-500 dark:text-gray-400">
                                        {{ Number::format(0, 2)  }} MDL
                            ...
                            <div class="flex items-center justify-between w-full">
                                <p class="text-base font-semibold leading-4 text-gray-800 dark:text-gray-400">
                                    {{ __('success.order_details.total') }}
                                </p>
                                ...
                                <div class="flex items-center justify-center space-x-2">
                                    ...
                                    <div class="flex flex-col items-center justify-start">
                                        <p class="text-lg font-semibold leading-6 text-gray-800 dark:text-gray-400">
                                            {{ __('success.shipping.delivery_title') }}<br><span class="text-sm font-normal">{{ __('success.shipping.delivery_description') }}</span>
                                        </p>
                                    </div>
                                </div>
                                {{-- <p class="text-lg font-semibold leading-6 text-gray-800 dark:text-gray-400"> --}}
                                <p class="text-lg font-semibold leading-6 text-red-500 dark:text-gray-400">
                                    {{ Number::format(0, 2)  }} MDL
                                </p>
                            </div>
                        </div>
                ...
                <div class="flex items-center justify-start gap-4 px-4 mt-6 ">
                    <a wire:navigate href="{{ route('products')}}"
                        ...
                        {{ __('success.buttons.go_back_shopping') }}
                    </a>
                    <a wire:navigate href="{{route('my_orders.list')}}"
                        ...
                        {{ __('success.buttons.view_my_orders') }}
                    </a>
                </div>
            </div>
        </div>
