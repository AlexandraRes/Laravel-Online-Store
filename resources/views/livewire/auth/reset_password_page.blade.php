                    ...
                    <div class="mt-5">
                        ...
                        <form wire:submit.prevent="save">
                            ...
                            <div class="grid gap-y-4">
                                @if (session('error'))
                                    <div class="mt-2 bg-red-500 text-sm text-white rounded-lg p-4">
                                        <span id="hs-solid-color-danger-label" class="font-bold">
                                            {{ __('reset_password.flash.title') }}
                                        </span>
                                        <div>
                                            {{session('error')}}
                                        </div>
                                ...
                                <div>
                                    <label for="password" class="block text-sm mb-2 dark:text-white">
                                        {{ __('reset_password.form.password') }}
                                    </label>
                                    <div class="relative">
                                ...
                                <div>
                                    <label for="password_confirmation" class="block text-sm mb-2 dark:text-white">
                                        {{ __('reset_password.form.confirm_password') }}
                                    </label>
                                    <div class="relative">
