                ...
                <div class="p-4 sm:p-7">
                    ...
                    <div class="mt-5">
                        ...
                        <form wire:submit.prevent="save" novalidate>
                            @if (session('success'))
                                <div class="my-2 bg-teal-500 text-sm text-white rounded-lg p-4">
                                    <span id="hs-solid-color-success-label"
                                        class="font-bold">{{ __('forgot_password.flash.title') }}</span>
                            ...
                            <div class="grid gap-y-4">
                                ...
                                <button type="submit"
                                    ...
                                    <span wire:loading.remove wire:target="save()">
                                        {{ __('forgot_password.button.reset') }}
                                    </span>
                                    <span wire:loading wire:target="save()">
                                        {{ __('forgot_password.button.sending') }}
                                    </span>
                                </button>
                            </div>
                        </form>
